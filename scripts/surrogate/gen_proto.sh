#!/usr/bin/env bash
# Regenerate the surrogate protobuf bindings from the canonical .proto sources with buf
# (RM-P1-SURR-01). Mirrors astro-mine-core/scripts/gen_proto.sh.
#
...
echo "Generated: src/astro_mine/surrogate/_proto/surrogate_pb2.py(+.pyi)."
