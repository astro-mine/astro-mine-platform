...
`astro-mine-cloud` is a component of the [Astro-Mine](https://github.com/astro-mine)
...
- **Component design** —
  [`architecture/cloud.md`](https://github.com/astro-mine/docs/blob/main/architecture/cloud.md):
  purpose, principles, runtime, data, integration, security, and roadmap alignment for
  this package (distributed orchestration — Phase 0: container-first packaging + local
  `submit()`).
