...
`astro-mine-sim` is a component of the [Astro-Mine](https://github.com/astro-mine)
...
- **Component design** —
  [`architecture/sim.md`](https://github.com/astro-mine/docs/blob/main/architecture/sim.md):
