...
`astro-mine-prospect` is a component of the [Astro-Mine](https://github.com/astro-mine)
...
- **Component design** —
  [`architecture/prospect.md`](https://github.com/astro-mine/docs/blob/main/architecture/prospect.md):
