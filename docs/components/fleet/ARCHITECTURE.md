...
`astro-mine-fleet` is a component of the [Astro-Mine](https://github.com/astro-mine)
...
- **Component design** —
  [`architecture/fleet.md`](https://github.com/astro-mine/docs/blob/main/architecture/fleet.md):
  purpose, principles, runtime, data, integration, security, and roadmap alignment for
  this package (the SADF asset library + authoring toolchain).
